...
def main():
    ...
    parser.add_argument('--input_feature', type=str, default='mean_bold', help='input feature type', choices=['one_hot', 'coordinate', 'mean_bold', 'mean_bold_onehot', 'mean_bold_onehot_features'])
    ...
    for current_fold in args.fold_idx:
        ...
        model = GIN_InfoMaxReg(args.num_layers, args.num_mlp_layers, 400*train_graphs[0].node_features.shape[1], args.hidden_dim, num_classes, args.final_dropout, args.dropout_layers, args.learn_eps, args.graph_pooling_type, args.neighbor_pooling_type, args.sparsity, device).to(device)
