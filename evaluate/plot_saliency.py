...
def main():
    ...
    plot_nii(saliency0subjects, roiimgaffine, roiimgarray, roimeta, os.path.join(opt.expdir, opt.savedir), 'grad_female_final')
    plot_nii(saliency1subjects, roiimgaffine, roiimgarray, roimeta, os.path.join(opt.expdir, opt.savedir), 'grad_male_final')
    plot_nii(saliency0earlysubjects, roiimgaffine, roiimgarray, roimeta, os.path.join(opt.expdir, opt.savedir), 'grad_female_early')
    plot_nii(saliency1earlysubjects, roiimgaffine, roiimgarray, roimeta, os.path.join(opt.expdir, opt.savedir), 'grad_male_early')
    ...
    plot_nii(saliency0subjects, roiimgaffine, roiimgarray, roimeta, os.path.join(opt.expdir, opt.savedir), 'cam_female_final')
    plot_nii(saliency1subjects, roiimgaffine, roiimgarray, roimeta, os.path.join(opt.expdir, opt.savedir), 'cam_male_final')
    plot_nii(saliency0earlysubjects, roiimgaffine, roiimgarray, roimeta, os.path.join(opt.expdir, opt.savedir), 'cam_female_early')
    plot_nii(saliency1earlysubjects, roiimgaffine, roiimgarray, roimeta, os.path.join(opt.expdir, opt.savedir), 'cam_male_early')
...
def plot_nii(subject_list, roiimgaffine, roiimgarray, roimeta, savepath, desc):
    ...
    write_csv(saliency_img_normalized, roiimgarray, roimeta, savepath, 'normalized_{}'.format(desc))
    write_csv(saliency_img_normalized_posneg, roiimgarray, roimeta, savepath, 'normalized_posneg_{}'.format(desc))
    write_csv(saliency_img_positive, roiimgarray, roimeta, savepath, 'positive_{}'.format(desc))
    write_csv(saliency_img_negative, roiimgarray, roimeta, savepath, 'negative_{}'.format(desc))
